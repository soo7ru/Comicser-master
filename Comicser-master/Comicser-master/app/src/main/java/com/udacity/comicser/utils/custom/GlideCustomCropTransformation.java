...
/**
 * Custom Glide transformation used for top crop image positioning
 * Source: https://stackoverflow.com/questions/38236793/
 */

public class GlideCustomCropTransformation extends BitmapTransformation {

  private float xPercentage = 0.5f;
  private float yPercentage = 0.5f;

  public GlideCustomCropTransformation(Context context) {
    super(context);
  }

  public GlideCustomCropTransformation(Context context,
      @FloatRange(from = 0.0, to = 1.0) float xPercentage,
  ...
  public GlideCustomCropTransformation(BitmapPool bitmapPool) {
    super(bitmapPool);
  }
  ...
  @Override
  public String getId() {
    return "GlideCustomCropTransformation.com.bumptech.glide.load.resource.bitmap.x:" + xPercentage
        + ".y:" + yPercentage;
  }
   ...
   */
  private static Bitmap crop(Bitmap recycled, Bitmap toCrop, int width, int height,
